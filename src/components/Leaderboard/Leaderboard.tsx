...
const Leaderboard = (props: LeaderboardProps) => {
  ...
  const leadingColors = [
    {
      background:
        "linear-gradient(5deg,  rgba(242,215,12,1) 0%,rgba(250,240,255,1) 56%,rgba(252,235,0,1) 96%)",
      color: "black"
    },
    {
      background:
        "linear-gradient(5deg,  rgba(180,180,180,1) 0%,rgba(232,232,232,1) 56%)",
      color: "black"
    },
    {
      background:
        "linear-gradient(5deg, rgba(223,182,103,1) 0%, rgba(235,220,140,1) 50%,rgba(231,192,116,1) 96%)",
      color: "white"
    }
  ];
