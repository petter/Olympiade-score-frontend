...
export interface SetScore extends PayloadedAction<'groups/setScore', GroupPayload<number>> { };
export const setScore = createPayloadedAction<SetScore>('groups/setScore');

export interface AddScore extends PayloadedAction<'groups/addScore', GroupPayload<number>> { };
export const addScore = createPayloadedAction<AddScore>('groups/addScore');

export interface SubScore extends PayloadedAction<'groups/subScore', GroupPayload<number>> { };
...
export interface AddGroup extends PayloadedAction<'group/addGroup', GroupState> { };
export const addGroup = createPayloadedAction<AddGroup>('group/addGroup');

export interface RemoveGroup extends PayloadedAction<'group/removeGroup', string> { };
export const removeGroup = createPayloadedAction<RemoveGroup>('group/removeGroup');
